...
function Password_generator() {
  return (
    <div className="px-8 md:px-16 lg:px-28 ">
      <div className=" relative text-center  space-y-3 md:space-y-8 md:flex md:flex-col md:text-center  md:items-center lg:text-left lg:items-start">
        <h1 className="text-2xl md:text-[40px] md:leading-tight lg:w-[500px]  font-bold  mt-9 text-primary">
          Générateur de mot de passe aléatoire
        </h1>
        <p className="text-small_p text-sm md:text-xl md:font-normal md:w-[580px]">
